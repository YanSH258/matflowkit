...
from tcct.report.html import render_abacus_report
from tcct.report.schema import abacus_tasks_schema
...
def _write_figures(output: Path, report: dict) -> None:
    ...
    from tcct.common.plot_style import COLORS, apply_plot_style, figure_size, save_figure
