...
from matflowkit.deepmd.dataset import (
    DeepMDSystem, find_systems, load_array, read_system, reshape_frames, set_directories,
)
from matflowkit.dpdata.overlap import normalized_frame_hash
from matflowkit.report.html import render_deepmd_report
...
def _require_matplotlib():
    ...
    from matflowkit.common.plot_style import apply_plot_style
    apply_plot_style()
    return plt
...
def _write_figures(output: Path, analysis: dict) -> None:
    ...
    from matflowkit.common.plot_style import COLORS, figure_size, save_figure
