...
from matflowkit.abacus.audit import parse_basis_type, parse_calculation
from matflowkit.common.io import sha256_file, write_csv, write_json, write_sha256_manifest
from matflowkit.structure.convert import _require_ase, write_abacus_stru
...
def prepare_from_xyz(
    ...
    staging = output.with_name(f".{output.name}.mfk-{uuid.uuid4().hex}")
    try:
