...
from tcckit.deepmd.dataset import (
    DeepMDSystem, find_systems, load_array, read_system, reshape_frames, set_directories,
)
from tcckit.dpdata.overlap import normalized_frame_hash
from tcckit.report.html import render_deepmd_report
from tcckit.report.schema import deepmd_dataset_schema
...
def _require_matplotlib():
    ...
    from tcckit.common.plot_style import apply_plot_style
    apply_plot_style()
    return plt
...
def _write_figures(output: Path, analysis: dict) -> None:
    ...
    from tcckit.common.plot_style import COLORS, figure_size, save_figure
