...
Use TCCT's `dpa4` skill for inference-only `relax`, `batch-relax`, `evaluate`, and
...
Copyright 2026 YanSH258. Original TCCT skill based on practical DPA4 fine-tuning workflows
