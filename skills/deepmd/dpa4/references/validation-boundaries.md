...
- State that TCCT reports a DPA4 minimum-energy path. Validate key endpoints and the highest-energy region with DFT before making a DFT barrier claim.
...
- “The TCCT DPA4 + PBE-D3(BJ) relaxation reached `fmax < 0.05 eV/Å`.”
