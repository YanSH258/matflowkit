# MatFlowKit DPA4 commands

Read this reference when choosing a command, constructing inputs, predicting outputs, resuming work, or interpreting exit codes. Confirm details against `mfk dpa4 COMMAND -h` in the active checkout.
...
```bash
mfk dpa4 batch-relax structures.csv --retry-failed --strict
```
